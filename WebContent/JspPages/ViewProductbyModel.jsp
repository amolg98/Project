...
<tr><th>Product Model Id:</th><td><input type="text" name="prodModelId" onkeydown="f(this)" onkeyup="f(this)" onblur="f(this)" onclick="f(this)"></input></td><td align="center" colspan="2"><input type="submit" value="submit"></input></td></tr>
</table>
