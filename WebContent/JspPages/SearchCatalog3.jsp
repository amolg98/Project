...
<h3 align="center">Choose a search type</h3>
...
else if(request.getParameter("option").equals("Brand"))
{
%>
...
else if(request.getParameter("optionChoosen").equals("Product"))
{
%>
...
<table align="center" border="2" id="searchtype">
<tr><th>Model Id</th><th>Model Name</th><th>Model Description</th><th>Model Features</th><th>Model Price</th><th>Model Product Code</th><th>Status</th></tr>
<%for(Search sList:searchList)
{
%>
	<tr><td><%=sList.getProdModelId() %></td><td><%=sList.getProdModelName()%></td><td><%=sList.getProdModelDesc()%></td><td><%=sList.getProdModelFeatures()%></td><td><%=sList.getProdModelPrice()%></td><td><%=sList.getProdCode()%></td><td><%=sList.getProdModelStatus()%></td></tr>
<%
}
%>
</table>
...
<script type="text/javascript"><!--
        var pager = new Pager('searchtype',25); 
        pager.init(); 
